...
image_tag="cogame-battlecode-replay-viewer-build:$$"
container_id=""
cleanup() {
...
# It is baked into the wasm (-d:bcSimSourcesStamp) and exported as
# bc_sim_sources_stamp_ptr/len so tools/wasm_replay_smoke.cjs can recompute
...
docker cp "${container_id}:/workspace/battlecode/replay-viewer/dist/." "${output_dir}"
